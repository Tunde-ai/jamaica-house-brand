...
const tests = [
  ...
  { name: 'Shop page', method: 'GET', path: '/shop', expect: { status: 200, contentIncludes: ['$6.99', '$11.99', '$19.99'] } },
  { name: 'Product: Original Jerk Sauce 2oz', method: 'GET', path: '/products/jerk-sauce-2oz', expect: { status: 200 } },
  { name: 'Product: Original Jerk Sauce 5oz', method: 'GET', path: '/products/jerk-sauce-5oz', expect: { status: 200 } },
  { name: 'Product: Original Jerk Sauce 10oz', method: 'GET', path: '/products/jerk-sauce-10oz', expect: { status: 200 } },
  ...
  },
  {
    ...
    body: {
      ...
      items: [{ sku: 'jerk-sauce-5oz', quantity: 1 }]
    },
...
async function preFlightCheck() {
  try {
    ...
    console.error('  cd /Users/rfmstaff/Desktop/THE VAULT/01_Projects/jamaica-house-brand');
