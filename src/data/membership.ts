...
export const membershipTiers: MembershipTier[] = [
  {
    ...
    price: 75,
    interval: 'year',
    description: '13 bottles of our 5oz Jerk Sauce — shipped quarterly (4 shipments/year).',
    features: [
  ...
  },
  {
    ...
    price: 125,
    interval: 'year',
    description: '13 bottles of our 10oz Jerk Sauce — shipped quarterly (4 shipments/year).',
    highlight: true,
    features: [
